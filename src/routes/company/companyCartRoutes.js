...
router
  ...
  .put(protect, upload.fields([{ name: 'teller', maxCount: 1 }]), editCompanyCart)
...
router.route("/uploadteller").put(protect, upload.fields([{ name: 'teller', maxCount: 1 }]), uploadTellerImage)
