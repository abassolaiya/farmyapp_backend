...
router
  .route('/profile')
  .put(protect, upload.fields([{ name: 'avatar', maxCount: 1 }, { name: 'coverPhoto', maxCount: 1 }]), updateLogisticsProfile1)
  .get(protect, getLogisticsProfile)


router.post('/', upload.fields([{ name: 'avatar', maxCount: 1 }, { name: 'coverPhoto', maxCount: 1 }]), registerLogistics);
