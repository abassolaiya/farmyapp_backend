  ...
  try {
    ...
    for (const participant of chat.participants) {
      ...
      if (participantId !== sender.toString()) {
        ...
        const notification = await createNotification(userType, user, message, link, req.app.get("socketio"));
      }
    }
...
//     // Create a notification for the recipient of the message using createNotification function
//     const notificationMessage = 'You have a new message.';
//     const notificationLink = `/chat/${chatId}`;
